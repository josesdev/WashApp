...
<div class="form-group register">
    ...
    <input id="user_dni" class="form-control" type="text" pattern="[0-9]{8}" name="user_dni" value="39.233.433" required />

    <label for="user_name" class="col-lg-4 control-label">CUIL</label>
    <input id="user_name" class="form-control" type="text" pattern="[a-zA-Z0-9]{2,64}" name="user_name" value="30-39.233.433-1" required />
...
<input type="submit" class="btn btn-success submitL" name="login" value="Actualizar datos" />
</form>
