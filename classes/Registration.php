...
class Registration
{
    ...
    private function registerNewUser($user_name, $user_email, $user_password, $user_password_repeat, $captcha)
    {
        ...
        // finally if all the above checks are ok
            ...
            if (count($result) > 0) {
                ...
                // check if we have a constant HASH_COST_FACTOR defined (in hashing.php),
                ...
                if ($query_new_user_insert) {
                    ...
                    if ($this->sendVerificationEmail($user_id, $user_email, $user_activation_hash) or true) {
    ...
    public function sendVerificationEmail($user_id, $user_email, $user_activation_hash)
    {
        ...
        // please look into the config.php for much more info on how to use this!
        ...
        // the link to your register.php, please set this value in email_verification.php
